                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <ul className="flex flex-col space-y-4 text-lg">
                            {navLinks.map((item) => (
                                <li key={item.href}>
                                    <a href={item.href} onClick={() => setMobileMenuOpen(false)} className="block py-2 font-semibold text-[#c96230]">
                                        {item.label}
                                    </a>
                                </li>
                            ))}
                ...
                <div className="relative mx-auto flex h-[80vh] w-full max-w-7xl items-center justify-start overflow-hidden rounded-[30px]">
                    ...
                    <div className="relative z-10 max-w-xl px-12 text-white">
                        ...
                        <div className="mt-6 flex space-x-4">
                            <button className="flex items-center rounded-full bg-[#c96230] px-6 py-3 font-semibold text-white shadow transition hover:bg-[#b75124]">
                                Get Started <ArrowUpRight className="ml-2 h-4 w-4" />
                            </button>
                            <button className="flex items-center rounded-full border border-white px-5 py-3 text-white transition hover:bg-white hover:text-[#c96230]">
