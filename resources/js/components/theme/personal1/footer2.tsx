...
export default function Footer2({ location, name, username }: contactProps) {
    return (
        <div className="flex flex-col items-center justify-between bg-black px-4 pt-20 pb-40 font-sans text-white">
            <motion.div
