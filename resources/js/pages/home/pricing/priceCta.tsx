    ...
    return (
        <>
            <motion.div
                ...
                className="mx-auto max-w-6xl rounded-xl p-6 text-center"
            >
            ...
            <section className="bg-grey mt-5">
                <div className="mx-auto flex max-w-6xl flex-col items-center justify-between px-4 py-16 text-center lg:flex-row">
                    <div>
                        <motion.h2
